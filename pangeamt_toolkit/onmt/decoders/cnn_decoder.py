...
from pangeamt_toolkit.onmt.modules import ConvMultiStepAttention, GlobalAttention
from pangeamt_toolkit.onmt.utils.cnn_factory import shape_transform, GatedConv
