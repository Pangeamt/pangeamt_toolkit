...
class BPE(object):
    ...
    def __init__(self, codes, merges=-1, separator='@@', vocab=None, vocab_threshold=None, glossaries=None):
        ...
        if vocab:
            if vocab_threshold:
                self.vocab = read_vocabulary(vocab, vocab_threshold)
            else:
                self.vocab = read_vocabulary(vocab, 50)
        else:
            self.vocab = None
...
if __name__ == '__main__':
    ...
    bpe = BPE(args.codes, args.merges, args.separator, args.vocabulary, args.vocabulary_threshold, args.glossaries)
